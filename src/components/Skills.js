    ...
    render() {
      return (
        <div  class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div class="grid container mx-auto grid-cols-1 grid-rows-2 sm:grid-cols-2 sm:grid-rows-1 gap-4 mt-16">
            {/* Java Programming */}
            ...
            {/* Spring Security */}
            <div class="flex sm:hidden items-center justify-center border-t p-4">
            ...
            <div class="hidden sm:flex items-center justify-center border-t p-4">
              <img src="./assets/img/Spring.png" alt="Security" height="200" width="400" />
            </div>

            {/* MySql */}
            <div class="flex items-center justify-center border-t p-4">
              <img src="./assets/img/MySql.png" alt="Workbench" height="200" width="400" />
            </div>
            <div class="flex flex-col justify-center border-t p-4">
            ...
            {/* React */}
            <div class="flex sm:hidden items-center justify-center border-t p-4">
              <img src="./assets/img/React.png" alt="React" height="200" width="400" />
            </div>  
            <div class="flex flex-col justify-center border-t p-4">
            ...
            {/* Testing */}
            <div class="flex items-center justify-center border-t p-4">
              <img src="./assets/img/Debugging.png" alt="Debug" height="200" width="400" />
            </div>
            <div class="flex flex-col justify-center border-t p-4">
