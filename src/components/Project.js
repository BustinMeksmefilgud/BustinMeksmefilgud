              ...
              {/*End of Row 1*/}   
               ...
               <div class="group bg-teal-200 hover:bg-teal-300 duration-300 p-4">
                <a target="_blank" href="https://mealsonwheels.yeems214.xyz/">    
                  <img src="./assets/img/MealsOnWheels.png" alt="A project of mine" class="object-cover w-full h-80 hover:-translate-y-1 hover:scale-60 hover:p-4 duration-300" />
                </a> 
                <div class="px-4 py-3 text-gray-800">
                  <h2 class="text-4xl md:text-5xl font-bold mb-8 text-center hover:-translate-y-1 hover:scale-110 hover:p-4 duration-300"><a target="_blank" href="https://mealsonwheels.yeems214.xyz/">Meals on Wheels</a></h2>
